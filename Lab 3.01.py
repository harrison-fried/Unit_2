...
'''
import random 
magicresponse = ['Outlook is good', 'Ask again later', 'yes', 'no', 'most likely no', 'most likely yes', 'maybe', 'outlook is not looking good']
question = input("Ask the magic 8 ball one question and one question only! ")
random_num = random.randint(0,7)
print(magicresponse[random_num])
